...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.image_circle_width);
    }
    ...
    @Override
    public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull CircleImageView child, @NonNull View directTargetChild, @NonNull View target, int axes) {
        return true;
    }
